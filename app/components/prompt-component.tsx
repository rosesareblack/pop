                  ...
                  <div className="relative">
                    ...
                    {speechSupported && (
                      <Button
                        ...
                        variant="ghost"
                        size="icon"
                        className={`absolute top-1/2 -translate-y-1/2 h-8 w-8 sm:h-10 sm:w-10 ${
                          isListening
                    ...
                    <Button
                      ...
                      size="icon"
                      className="absolute right-0 top-1/2 -translate-y-1/2 h-8 w-8 sm:h-10 sm:w-10 rounded-full"
                    >
                      {isLoading ? (
